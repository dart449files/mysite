            ...
            if(controller.info("scrollDirection")==='FORWARD'){
              $("#brandingPin").html("Why the Tiffany branding?");
               ...
               $("#brandingPin").html("Grapefruits and diamonds<br>have a lot in common.");
                  ...
                  var scene = new ScrollMagic.Scene({triggerElement: "#summaryPin", duration: 1450, offset:120})
                  .setPin("#summaryPin")
                  // .addIndicators({name: "1 (duration: 300)"}) // add indicators (requires plugin)
                
                  .on("enter", function (e) {
                    if(controller.info("scrollDirection")==='FORWARD'){
                      $("#summaryPin").html("The real cost of diamonds<br>isn’t dollars 💸");
                
                    }
                    else{
                       $("#brandisummaryPinngPin").html("We're wasting human lives<br>for shiny rocks");
                    }
                    })
                          ...
                          .on("progress", function (e) {
                            ...
                            $("#summaryPin").html("We're wasting human lives<br>for shiny rocks");
                            // $("#progress").text(e.progress.toFixed(3));
                            console.log(e.progress.toFixed(3))
                          }
                          })
...
var scene = new ScrollMagic.Scene({triggerElement: "#textPin2", duration: 1000})
          ...
          var scene = new ScrollMagic.Scene({triggerElement: "#LastfruitPinned", duration: 1800, offset: 170})
          .setPin("#LastfruitPinned")
    
          .addTo(controller);


          var scene = new ScrollMagic.Scene({triggerElement: "#LastfruitPin", duration: 1800, offset: 285})
          .setPin("#LastfruitPin")
