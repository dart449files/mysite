  ...
  var scene = new ScrollMagic.Scene({triggerElement: "#textPin1", duration: 1000})
          ...
          .on("enter", function (e) {
            if(controller.info("scrollDirection")==='FORWARD'){
              ...
              $("#textPin1").html("We’re hidden from the labor abuses, suffering, and<br>general mistreatment that takes place to bring us our produce.");
            }
          })

          .on("progress", function (e) {
            if(e.progress.toFixed(3)>.5 && e.progress.toFixed(3)<.7){

            // console.log(controller.info("scrollDirection"))


            $("#textPin1").html("<span class='left-nudge'>We’re hidden from the labor abuses, suffering, and<br>general mistreatment that takes place to bring us our produce.</span>");
            // $("#progress").text(e.progress.toFixed(3));
            console.log(e.progress.toFixed(3))
          }

          if(e.progress.toFixed(3)>.7){
          ...
          .on("leave", function (e) {
            if(controller.info("scrollDirection")==='FORWARD'){
              ...
              $("#textPin1").html("Buying food in supermarkets leaves us detatched from the origins of our produce.");
...
var scene = new ScrollMagic.Scene({triggerElement: "#textPin2", duration: 1000})
          ...
          .on("leave", function (e) {
            if(controller.info("scrollDirection")==='FORWARD'){
              $("#textPin2").html("We’re all in this together, and that we should<br>strive to leave the world in a better place for<br>the generations that come tomorrow 🌍");
            }
