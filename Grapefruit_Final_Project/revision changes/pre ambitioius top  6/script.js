...
// MY FIRST PIN
  ...
  var scene = new ScrollMagic.Scene({triggerElement: "#textPin1", duration: 1000})
          ...
          .on("progress", function (e) {
            if(e.progress.toFixed(3)>.3 && e.progress.toFixed(3)<.6){
          ...
          if(e.progress.toFixed(3)>.6){
            $("#textPin1").html("Food waste is a serious issue that effects everyone.");
          }
					})
...
var scene = new ScrollMagic.Scene({triggerElement: "#textPinFirst", duration: 2500, delay: 200})
.setPin("#textPinFirst")
.addTo(controller);

var scene = new ScrollMagic.Scene({triggerElement: "#textPinSecond", duration: 2500, delay: 200})
.setPin("#textPinSecond")
.addTo(controller);

var scene = new ScrollMagic.Scene({triggerElement: "#textPinThird", duration: 2500, delay: 200})
.setPin("#textPinThird")
.addTo(controller);



var scene = new ScrollMagic.Scene({triggerElement: "#textPinContain", duration: 2500})
          .setPin("#textPinContain")
          // .addIndicators({name: "1 (duration: 300)"}) // add indicators (requires plugin)

          .on("enter", function (e) {
            if(controller.info("scrollDirection")==='FORWARD'){
              $("#textPinContain").html("At almost $1 a piece they’re a luxury good<br>not everyone can afford to enjoy");

            }
            else{
              $("#textPinContain").html("Let alone waste");
            }
          })
          ...
          if(e.progress.toFixed(3)>.6){
            $("#textPinContain").html("How much food do you waste a week?");
          }
					})
          ...
          .on("leave", function (e) {
            if(controller.info("scrollDirection")==='FORWARD'){
              $("#textPtextPinContaininFirst").html("How much food do you waste a week?");
            }
...
var scene = new ScrollMagic.Scene({triggerElement: "#textPin2", duration: 1000})
          ...
          var scene = new ScrollMagic.Scene({triggerElement: "#textPin3", duration: 1000})
          .setPin("#textPin3")
          // .addIndicators({name: "1 (duration: 300)"}) // add indicators (requires plugin)

          .on("enter", function (e) {
            if(controller.info("scrollDirection")==='FORWARD'){
              $("#textPin3").html("The real cost of<br>diamonds isn’t dollars");
          ...
          .on("progress", function (e) {
            ...
            $("#textPin3").html("Just as your grapefruit really<br>costs more than $1");
            // $("#progress").text(e.progress.toFixed(3));
            console.log(e.progress.toFixed(3))
          }
					})
          ...
          var scene = new ScrollMagic.Scene({triggerElement: "#kanyePin", duration: 1000, offset: 240})
          .setPin("#kanyePin")
          ...
          .addTo(controller);
           ...
           // diamond Section
            ...
            var scene = new ScrollMagic.Scene({triggerElement: "#textPin4", duration: 1200})
            .setPin("#textPin4")
            // .addIndicators({name: "1 (duration: 300)"}) // add indicators (requires plugin)
          
            .on("enter", function (e) {
              if(controller.info("scrollDirection")==='FORWARD'){
                $("#textPin4").html("This shiny jewely comes<br>at a horrible price");
                 ...
                 $("#textPin4").html("Text3");
                    ...
                    .on("progress", function (e) {
                      ...
                      $("#textPin4").html("Diamonds aren't all that valuble in the first place");
                      // $("#progress").text(e.progress.toFixed(3));
                      console.log(e.progress.toFixed(3))
                    }
                    })
                    ...
                    var scene = new ScrollMagic.Scene({triggerElement: "#diamondPin", duration: 1200, offset: 0})
                    .setPin("#diamondPin")
